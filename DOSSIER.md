...
| Field | Value |
|-------|-------|
| Max | [Your name or alias] |
| 34 | [Age] |
| 187 | [cm] |
| 81 | [kg] |
| 79 | [kg] |
| Regensburg, Germany | [City, Country] |
...
| Type | Description |
|------|-------------|
| Primary | [Running Performance for Marathon] |
| Secondary | [Triathlon middle distance] |
...
**Training Style:** [polarized (~8h/week)]
...
|----------|-----------|---------|
| [Strength] | [gym] | lower Body and core strength |
| [Relax] | [Sauna] | Relaxing after strength workout |
...
| Factor | Details |
|--------|---------|
| Indoor | Little Training space with indoor Trainer and fan |
| Outdoor | road, typical german weather, currently spring with 10 to 15 Degrees celsius |
| Calibration | [after every switch between bikes] |
...
|-----|-----------------|----------|-----------|
| Sunday | [Long run] | [90min to 120min] | [Gym] |
...
[Have typical running injuries from time to time just as runners knee, achilles tendon.... Currently much better beacause of regular gym sessions (once or twice per week)]
